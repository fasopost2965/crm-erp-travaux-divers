...
const QuoteDetail = () => {
  ...
  const statusMutation = useMutation({
    ...
    onSuccess: (data, newStatus) => {
      showToast(`Devis mis à jour avec le statut: ${newStatus}`);
  ...
  return (
    <div className="space-y-6 font-sans">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {quote.status === 'Accepté' && (
              <button
                ...
                className="py-2.5 px-5 rounded-xl bg-blue-600 hover:bg-blue-550 text-white font-bold text-xs tracking-wide shadow-md shadow-blue-900/10 transition-all cursor-pointer"
              >
      ...
      <ConfirmDialog
        ...
        message="Voulez-vous notifier le système que ce devis a été envoyé au client ? Son statut passera à 'Envoyé'."
      ...
      <ConfirmDialog
        ...
        message="Êtes-vous sûr de vouloir marquer ce devis comme accepté ? Cette action validera le budget et vous permettra de le convertir en chantier."
      ...
      <ConfirmDialog
        ...
        message="Êtes-vous sûr de vouloir classer ce devis comme refusé ?"
