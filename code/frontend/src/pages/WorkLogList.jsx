...
const STATUS_CONFIG = {
  ...
  submitted: { label: 'Soumis',     cls: 'bg-[#FDF0EA] text-[#A8481F] border-[#FADDCC]' },
        ...
        {(dateFilter || statusFilter) && (
          <div className="flex items-end">
            <button
              ...
              className="py-2 px-4 text-sm text-slate-500 hover:text-[#C85A2A] font-medium transition-colors"
            >
              Réinitialiser
            </button>
          </div>
