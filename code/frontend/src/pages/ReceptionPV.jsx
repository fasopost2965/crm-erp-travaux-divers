      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="px-4 py-3 bg-blue-50 border border-blue-200 rounded-xl">
            ...
            <p className="text-xs text-blue-500">Conducteur de travaux — BATIPLUS SARL</p>
          </div>
        ...
        <button
          ...
          className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm shadow-sm transition-colors disabled:opacity-60"
        >
